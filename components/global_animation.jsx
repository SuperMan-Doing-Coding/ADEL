...
export default function AdelLoader() {
  ...
  return (
    ...
    >
      ...
      <div
        ref={glowCircleRef}
        className="absolute w-96 h-96 rounded-full bg-gradient-to-r from-purple-500/30 via-pink-500/30 to-cyan-500/30 blur-3xl transition-all duration-700 ease-out"
      />
      ...
      <div className="relative z-10 flex items-center gap-2">
        ...
        {["A", "D", "E", "L"].map((letter, i) => (
          <div
            ...
            className="text-8xl md:text-9xl font-black tracking-tight opacity-0 translate-y-8 transition-all duration-500 ease-out"
            style={{
        ...
        <div
          ref={tildeRef}
          className="text-7xl md:text-8xl font-black opacity-0 transition-all duration-700 ease-out"
          style={{
          ...
          {[...Array(3)].map((_, i) => (
            <div
              ...
              style={{
                top: "50%",
                left: "50%",
                transform: `rotate(${i * 120}deg) translateX(250px)`,
